...
class deneme4 : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private lateinit var database: FirebaseFirestore
    private lateinit var recyclerViewAdapter: tariffeedadapter2_4
    var tariflistesi = ArrayList<tarif4>()
    //val displayList = ArrayList<tarif>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_deneme4)
        ...
        recyclerViewAdapter = tariffeedadapter2_4(tariflistesi)
        ...
        exitbutton1.setOnClickListener {
            val intent = Intent(this@deneme4, MainActivity::class.java)
            startActivity(intent)
            finish()
        }
       commentbutton_2.setOnClickListener {
            val intent = Intent(this@deneme4, tarifekle4::class.java)
            startActivity(intent)
            finish()
        }
                    ...
                    if (snapshot != null) {
                        if (!snapshot.isEmpty) {
                            ...
                            for (document in documents) {
                                ...
                                val indirilenpost1 = tarif4(tarifadi,kullaniciemaili,tarifkategori,tarifmalzemeler,tarifmalzemeolculeri,tarifinstructions,x)
