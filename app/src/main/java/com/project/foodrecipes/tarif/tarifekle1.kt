...
import com.project.foodrecipes.tarif.tarifekle1
...
import kotlinx.android.synthetic.main.activity_tarifekle1.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle1)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle1, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle1.setOnClickListener {
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("pasta resimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("pasta resimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Pasta").add(postHashMap1)
