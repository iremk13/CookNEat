...
import com.project.foodrecipes.tarif.tarifekle4
...
import kotlinx.android.synthetic.main.activity_tarifekle4.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle4)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle4, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle4.setOnClickListener {
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("lamb resimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("lamb resimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Lamb").add(postHashMap1)
