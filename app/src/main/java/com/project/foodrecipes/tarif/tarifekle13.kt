...
import com.project.foodrecipes.tarif.tarifekle13
...
import kotlinx.android.synthetic.main.activity_tarifekle13.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle13 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle13)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle13, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle13.setOnClickListener {
            //tarifekle()
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("breakfastresimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("breakfastresimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Breakfast").add(postHashMap1)
