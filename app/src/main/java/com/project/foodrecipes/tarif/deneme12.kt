...
class deneme12 : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private lateinit var database: FirebaseFirestore
    private lateinit var recyclerViewAdapter: tariffeedadapter2_12
    var tariflistesi = ArrayList<tarif12>()
    //val displayList = ArrayList<tarif>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_deneme12)
        ...
        recyclerViewAdapter = tariffeedadapter2_12(tariflistesi)
        ...
        exitbutton1.setOnClickListener {
            val intent = Intent(this@deneme12, MainActivity::class.java)
            startActivity(intent)
            finish()
        }
       commentbutton_2.setOnClickListener {
            val intent = Intent(this@deneme12, tarifekle12::class.java)
            startActivity(intent)
            finish()
        }
    ...
    fun veri12() {
        database.collection("Vegetarian")
                    ...
                    if (snapshot != null) {
                        if (!snapshot.isEmpty) {
                            ...
                            for (document in documents) {
                                ...
                                val indirilenpost1 = tarif12(tarifadi,kullaniciemaili,tarifkategori,tarifmalzemeler,tarifmalzemeolculeri,tarifinstructions,x)
