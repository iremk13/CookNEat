...
class deneme10 : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private lateinit var database: FirebaseFirestore
    private lateinit var recyclerViewAdapter: tariffeedadapter2_10
    var tariflistesi = ArrayList<tarif10>()
    //val displayList = ArrayList<tarif>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_deneme10)
        ...
        recyclerViewAdapter = tariffeedadapter2_10(tariflistesi)
        ...
        exitbutton1.setOnClickListener {
            val intent = Intent(this@deneme10, MainActivity::class.java)
            startActivity(intent)
            finish()
        }
       commentbutton_2.setOnClickListener {
            val intent = Intent(this@deneme10, tarifekle10::class.java)
            startActivity(intent)
            finish()
        }
                    ...
                    if (snapshot != null) {
                        if (!snapshot.isEmpty) {
                            ...
                            for (document in documents) {
                                ...
                                val indirilenpost1 = tarif10(tarifadi,kullaniciemaili,tarifkategori,tarifmalzemeler,tarifmalzemeolculeri,tarifinstructions,x)
