...
import com.project.foodrecipes.tarif.tarifekle6
...
import kotlinx.android.synthetic.main.activity_tarifekle6.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle6)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle6, MainActivity::class.java)
            startActivity(intent)
            finish()
            ...
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    ...
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Pork").add(postHashMap1)
