...
class deneme2 : AppCompatActivity() {
    ...
    private lateinit var recyclerViewAdapter: tariffeedadapter2_2
    var tariflistesi = ArrayList<tarif2>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewAdapter = tariffeedadapter2_2(tariflistesi)
        ...
        exitbutton1.setOnClickListener {
            val intent = Intent(this@deneme2, MainActivity::class.java)
            startActivity(intent)
            finish()
        }
       commentbutton_2.setOnClickListener {
            val intent = Intent(this@deneme2, tarifekle2::class.java)
            startActivity(intent)
            finish()
        }
                    ...
                    if (snapshot != null) {
                        if (!snapshot.isEmpty) {
                            ...
                            for (document in documents) {
                                ...
                                val indirilenpost1 = tarif2(tarifadi,kullaniciemaili,tarifkategori,tarifmalzemeler,tarifmalzemeolculeri,tarifinstructions,x)
