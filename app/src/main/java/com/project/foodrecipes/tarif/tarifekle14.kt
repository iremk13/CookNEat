...
import com.project.foodrecipes.tarif.tarifekle14
...
import kotlinx.android.synthetic.main.activity_tarifekle14.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle14 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle14)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle14, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle14.setOnClickListener {
            //tarifekle()
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("goatresimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("goatresimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Goat").add(postHashMap1)
