...
import com.project.foodrecipes.tarif.tarifekle12
...
import kotlinx.android.synthetic.main.activity_tarifekle12.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle12 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle12)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle12, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle12.setOnClickListener {
            //tarifekle()
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("vegetarian resimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("vegetarian resimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Vegetarian").add(postHashMap1)
