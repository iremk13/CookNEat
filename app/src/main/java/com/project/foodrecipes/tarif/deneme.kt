...
class deneme : AppCompatActivity() {
    ...
    private lateinit var recyclerViewAdapter: tariffeedadapter2
    var tariflistesi = ArrayList<tarif>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewAdapter = tariffeedadapter2(tariflistesi)
        ...
        exitbutton1.setOnClickListener {
            val intent = Intent(this@deneme, MainActivity::class.java)
            startActivity(intent)
            finish()
        }
       commentbutton_2.setOnClickListener {
            val intent = Intent(this@deneme, tarifekle::class.java)
            startActivity(intent)
            finish()
        }
                    ...
                    if (snapshot != null) {
                        if (!snapshot.isEmpty) {
                            ...
                            for (document in documents) {
                                ...
                                val indirilenpost1 = tarif(tarifadi,kullaniciemaili,tarifkategori,tarifmalzemeler,tarifmalzemeolculeri,tarifinstructions,x)
