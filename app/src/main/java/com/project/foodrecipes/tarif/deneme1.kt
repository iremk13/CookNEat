...
class deneme1 : AppCompatActivity() {
    ...
    private lateinit var recyclerViewAdapter: tariffeedadapter2_1
    var tariflistesi = ArrayList<tarif1>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewAdapter = tariffeedadapter2_1(tariflistesi)
        ...
        exitbutton1.setOnClickListener {
            val intent = Intent(this@deneme1, MainActivity::class.java)
            startActivity(intent)
            finish()
        }
       commentbutton_2.setOnClickListener {
            val intent = Intent(this@deneme1, tarifekle1::class.java)
            startActivity(intent)
            finish()
        }
                    ...
                    if (snapshot != null) {
                        if (!snapshot.isEmpty) {
                            ...
                            for (document in documents) {
                                ...
                                val indirilenpost1 = tarif1(tarifadi,kullaniciemaili,tarifkategori,tarifmalzemeler,tarifmalzemeolculeri,tarifinstructions,x)
