...
import com.project.foodrecipes.tarif.tarifekle3
...
import kotlinx.android.synthetic.main.activity_tarifekle3.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle3)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle3, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle3.setOnClickListener {
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("dessert resimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("dessert resimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Dessert").add(postHashMap1)
