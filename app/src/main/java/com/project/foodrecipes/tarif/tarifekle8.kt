...
import com.project.foodrecipes.tarif.tarifekle8
...
import kotlinx.android.synthetic.main.activity_tarifekle8.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle8 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle8, MainActivity::class.java)
            startActivity(intent)
            finish()
            ...
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    ...
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Side").add(postHashMap1)
