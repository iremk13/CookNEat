...
import com.project.foodrecipes.tarif.tarifekle11
...
import kotlinx.android.synthetic.main.activity_tarifekle11.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle11 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle11)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle11, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle11.setOnClickListener {
            //tarifekle()
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("vegan food resimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("vegan food resimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("Vegan").add(postHashMap1)
