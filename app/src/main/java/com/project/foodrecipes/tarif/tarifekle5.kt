...
import com.project.foodrecipes.tarif.tarifekle5
...
import kotlinx.android.synthetic.main.activity_tarifekle5.*
import kotlinx.android.synthetic.main.activity_warning.*

import java.util.*

class tarifekle5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tarifekle5)
       ...
       /* tarifekle.setOnClickListener {
        ...
        btnBack3.setOnClickListener {
            val intent = Intent(this@tarifekle5, MainActivity::class.java)
            startActivity(intent)
            finish()
    ...
    fun tarifekle(view: View) {
        ...
        tarifekle5.setOnClickListener {
            ...
            val reference1 =
                storage1.reference
            val gorselReference = reference1.child("miscellaneous resimleri")
                .child(gorselismi1)
            if (secilenGorsel != null) {
                gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { taskSnapshot ->
                    val yuklenenGorselReference1 =
                        FirebaseStorage.getInstance().reference.child("miscellaneous resimleri")
                            .child(gorselismi1)
                    yuklenenGorselReference1.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        database1.collection("miscellaneous").add(postHashMap1)
